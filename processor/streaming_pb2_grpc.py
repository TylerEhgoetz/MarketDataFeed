...
class TradeServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamTrades = channel.unary_stream(
                '/streaming.TradeService/StreamTrades',
                request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
                response_deserializer=streaming__pb2.Trade.FromString,
...
def add_TradeServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'StreamTrades': grpc.unary_stream_rpc_method_handler(
                    ...
                    response_serializer=streaming__pb2.Trade.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
            'streaming.TradeService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('streaming.TradeService', rpc_method_handlers)
...
class TradeService(object):
    ...
    def StreamTrades(request,
        ...
        return grpc.experimental.unary_stream(
            ...
            streaming__pb2.Trade.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
